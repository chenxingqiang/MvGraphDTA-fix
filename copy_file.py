...
destination_folder = "./data/binding_affinity/li_data/casf2016/target_node_edge_index/"

test_ids = pd.read_csv('./data/binding_affinity/li_data/casf2016.csv')['PDBID'].to_numpy().tolist()
print(test_ids)
